...
#define IMUtrigger_Pin GPIO_PIN_14
#define IMUtrigger_GPIO_Port GPIOD
...
struct tm parseUtcTime(const char *utcTimeStr);
void printFormattedTime(const struct tm *time);
